// OG image dinámica para /pokedex/[id]/history
// Tema: purple (gen history) — preview con sprite + "Historia gen by gen"

import { ImageResponse } from 'next/og';

export const runtime = 'edge';
export const alt = 'Historia de Pokémon a través de las generaciones';
...
export default async function HistoryOGImage({
  params,
}: {
      ...
      >
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            ...
            >
              Stats · Movepool · Tier · Gen 1 → Gen 9
            </div>
          </div>
          <div
            style={{
        ...
        >
          <div>pokehub.app/pokedex/{params.id}/history</div>
